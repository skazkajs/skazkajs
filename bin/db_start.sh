...
docker run -d --net=hostnet --name localstack -p 4563-4597:4563-4597 -e SERVICES=dynamodb,dynamodbstreams,s3,ssm,ec2,sns,ses -e DEFAULT_REGION=us-east-1 localstack/localstack
